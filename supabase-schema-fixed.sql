-- StudySync Database Schema for Supabase (FIXED ORDER)
-- Run this in Supabase SQL Editor

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 1. First create user_profiles (no dependencies)
...
-- 2. Create study_rooms BEFORE study_sessions (since sessions references rooms)
...
-- 3. Create tasks (self-referential but no external dependencies)
...
-- 4. Create study_sessions (depends on tasks and study_rooms)
